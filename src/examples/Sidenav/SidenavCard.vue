  ...
  >
    ...
    <div class="p-3 card-body text-start w-100">
      ...
      <div class="docs-info">
        ...
        <a href="mailto:guilherme.glier@universo.univates.br?cc=gabriel.ramos@universo.univates.br,tiago.portaluppi@universo.univates.br,gregor.almeida@universo.univates.br," target="_blank" class="mb-0 btn btn-white btn-sm w-100"
          >{{ label }}
        </a>
      </div>
    </div>
